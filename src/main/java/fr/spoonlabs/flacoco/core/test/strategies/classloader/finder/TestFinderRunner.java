...
public class TestFinderRunner implements Callable<List<TestContext>> {
    ...
    public List<TestContext> call() throws Exception {
        ...
        Processor processor = new Processor(classloaderFinder, new TestMethodFilter(EnumSet.of(TestType.JUNIT3_TEST, TestType.JUNIT4_TEST)));
        ...
        processor = new Processor(classloaderFinder, new TestMethodFilter(EnumSet.of(TestType.JUNIT5_TEST)));
